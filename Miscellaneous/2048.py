# http://www.rosettacode.org/wiki/Maze_generation#Python
# http://www.rosettacode.org/wiki/2048
...
def transpose(field):
    # want to return list of lists
    # list(*zip(field)) returns list of tuples
